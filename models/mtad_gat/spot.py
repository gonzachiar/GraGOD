...
class SPOT:
    ...
    def _rootsFinder(fun, jac, bounds, npoints, method):
        ...
        method : str
                'regular' : regular sample of the search interval, 'random' :
                    uniform (distribution) sample of the search interval
    ...
    def run(self, with_alarm=True, dynamic=True):
        ...
        for i in tqdm.tqdm(range(self.data.size)):
            if not dynamic:
                ...
                # case where the value exceeds the initial threshold
                # but not the alarm ones
...
class biSPOT:
    """
    This class allows to run biSPOT algorithm on univariate dataset
...
class bidSPOT:
    """
    This class allows to run DSPOT algorithm on univariate dataset
    (upper and lower bounds)
